...
echo_and_run /usr/bin/env \
    PYTHONPATH="/home/mars/MarquetteRMC2021/ros_catkin_ws/install/lib/python2.7/dist-packages:/home/mars/MarquetteRMC2021/ros_catkin_ws/build/gennodejs/lib/python2.7/dist-packages:$PYTHONPATH" \
    CATKIN_BINARY_DIR="/home/mars/MarquetteRMC2021/ros_catkin_ws/build/gennodejs" \
    "/usr/bin/python2" \
    "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/gennodejs/setup.py" \
     \
    build --build-base "/home/mars/MarquetteRMC2021/ros_catkin_ws/build/gennodejs" \
    install \
    --root="${DESTDIR-/}" \
