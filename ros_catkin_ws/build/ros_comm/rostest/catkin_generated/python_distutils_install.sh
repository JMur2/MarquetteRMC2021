...
echo_and_run cd "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/ros_comm/rostest"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/ros_comm/rostest/setup.py" \
     \
    build --build-base "/home/mars/MarquetteRMC2021/ros_catkin_ws/build/ros_comm/rostest" \
    install \
    --root="${DESTDIR-/}" \
