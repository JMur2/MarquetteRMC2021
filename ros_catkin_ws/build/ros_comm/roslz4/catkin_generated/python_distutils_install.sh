...
echo_and_run cd "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/ros_comm/roslz4"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/ros_comm/roslz4/setup.py" \
     \
    build --build-base "/home/mars/MarquetteRMC2021/ros_catkin_ws/build/ros_comm/roslz4" \
    install \
    --root="${DESTDIR-/}" \
