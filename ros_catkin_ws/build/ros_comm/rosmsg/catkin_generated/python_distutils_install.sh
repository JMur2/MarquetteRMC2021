...
echo_and_run cd "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/ros_comm/rosmsg"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/ros_comm/rosmsg/setup.py" \
     \
    build --build-base "/home/mars/MarquetteRMC2021/ros_catkin_ws/build/ros_comm/rosmsg" \
    install \
    --root="${DESTDIR-/}" \
