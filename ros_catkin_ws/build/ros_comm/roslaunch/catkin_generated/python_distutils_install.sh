...
echo_and_run cd "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/ros_comm/roslaunch"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/ros_comm/roslaunch/setup.py" \
     \
    build --build-base "/home/mars/MarquetteRMC2021/ros_catkin_ws/build/ros_comm/roslaunch" \
    install \
    --root="${DESTDIR-/}" \
