...
echo_and_run cd "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/rqt/rqt_gui"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/rqt/rqt_gui/setup.py" \
     \
    build --build-base "/home/mars/MarquetteRMC2021/ros_catkin_ws/build/rqt/rqt_gui" \
    install \
    --root="${DESTDIR-/}" \
