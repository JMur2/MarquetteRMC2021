...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/mars/MarquetteRMC2021/ros_catkin_ws/build/ros/rosmake \
    build --build-base "/home/mars/MarquetteRMC2021/ros_catkin_ws/build/ros/rosmake" \
    install \
    --root="${DESTDIR-/}" \
