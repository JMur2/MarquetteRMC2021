...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/mars/MarquetteRMC2021/ros_catkin_ws/build/ros/rosclean \
    build --build-base "/home/mars/MarquetteRMC2021/ros_catkin_ws/build/ros/rosclean" \
    install \
    --root="${DESTDIR-/}" \
