...
echo_and_run cd "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/rqt_py_console"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/rqt_py_console/setup.py" \
     \
    build --build-base "/home/mars/MarquetteRMC2021/ros_catkin_ws/build/rqt_py_console" \
    install \
    --root="${DESTDIR-/}" \
