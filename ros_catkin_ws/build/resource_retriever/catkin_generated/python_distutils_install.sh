...
echo_and_run cd "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/resource_retriever"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/resource_retriever/setup.py" \
     \
    build --build-base "/home/mars/MarquetteRMC2021/ros_catkin_ws/build/resource_retriever" \
    install \
    --root="${DESTDIR-/}" \
