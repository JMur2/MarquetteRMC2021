...
echo_and_run cd "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/rqt_srv"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/rqt_srv/setup.py" \
     \
    build --build-base "/home/mars/MarquetteRMC2021/ros_catkin_ws/build/rqt_srv" \
    install \
    --root="${DESTDIR-/}" \
