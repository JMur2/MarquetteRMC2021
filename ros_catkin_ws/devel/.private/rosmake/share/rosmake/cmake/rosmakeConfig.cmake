...
if("TRUE" STREQUAL "TRUE")
  set(rosmake_SOURCE_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/src/ros/rosmake)
  set(rosmake_DEVEL_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/devel/.private/rosmake)
  set(rosmake_INSTALL_PREFIX "")
  set(rosmake_PREFIX ${rosmake_DEVEL_PREFIX})
else()
  set(rosmake_SOURCE_PREFIX "")
  set(rosmake_DEVEL_PREFIX "")
  set(rosmake_INSTALL_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosmake' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mars/MarquetteRMC2021/ros_catkin_ws/src/ros/rosmake/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mars/MarquetteRMC2021/ros_catkin_ws/devel/.private/rosmake/lib;/home/mars/MarquetteRMC2021/ros_catkin_ws/install/lib;/opt/ros/melodic/lib)
