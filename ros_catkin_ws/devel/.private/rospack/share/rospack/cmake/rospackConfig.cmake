...
if("TRUE" STREQUAL "TRUE")
  set(rospack_SOURCE_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/src/rospack)
  set(rospack_DEVEL_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/devel/.private/rospack)
  set(rospack_INSTALL_PREFIX "")
  set(rospack_PREFIX ${rospack_DEVEL_PREFIX})
else()
  set(rospack_SOURCE_PREFIX "")
  set(rospack_DEVEL_PREFIX "")
  set(rospack_INSTALL_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/install)
...
if(NOT "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/rospack/include;/usr/include " STREQUAL " ")
  set(rospack_INCLUDE_DIRS "")
  set(_include_dirs "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/rospack/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rospack' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mars/MarquetteRMC2021/ros_catkin_ws/src/rospack/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rospack_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rospack;/usr/lib/x86_64-linux-gnu/libpython2.7.so;/usr/lib/x86_64-linux-gnu/libtinyxml2.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mars/MarquetteRMC2021/ros_catkin_ws/devel/.private/rospack/lib;/home/mars/MarquetteRMC2021/ros_catkin_ws/install/lib;/opt/ros/melodic/lib)
