...
if("TRUE" STREQUAL "TRUE")
  set(rosbash_SOURCE_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/src/ros/rosbash)
  set(rosbash_DEVEL_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/devel)
  set(rosbash_INSTALL_PREFIX "")
  set(rosbash_PREFIX ${rosbash_DEVEL_PREFIX})
else()
  set(rosbash_SOURCE_PREFIX "")
  set(rosbash_DEVEL_PREFIX "")
  set(rosbash_INSTALL_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbash' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mars/MarquetteRMC2021/ros_catkin_ws/src/ros/rosbash/${idir}'.  ${_report}")
    endif()
