...
if("TRUE" STREQUAL "TRUE")
  set(message_runtime_SOURCE_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/src/message_runtime)
  set(message_runtime_DEVEL_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/devel)
  ...
  set(message_runtime_INSTALL_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'message_runtime' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mars/MarquetteRMC2021/ros_catkin_ws/src/message_runtime/${idir}'.  ${_report}")
    endif()
