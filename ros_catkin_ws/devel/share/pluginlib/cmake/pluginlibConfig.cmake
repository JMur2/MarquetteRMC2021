...
if("TRUE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/src/pluginlib)
  set(pluginlib_DEVEL_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/devel)
  ...
  set(pluginlib_INSTALL_PREFIX /home/mars/MarquetteRMC2021/ros_catkin_ws/install)
...
if(NOT "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/pluginlib/include;/usr/include " STREQUAL " ")
  set(pluginlib_INCLUDE_DIRS "")
  set(_include_dirs "/home/mars/MarquetteRMC2021/ros_catkin_ws/src/pluginlib/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mars/MarquetteRMC2021/ros_catkin_ws/src/pluginlib/${idir}'.  ${_report}")
    endif()
    _list_append_unique(pluginlib_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/x86_64-linux-gnu/libtinyxml2.so")
