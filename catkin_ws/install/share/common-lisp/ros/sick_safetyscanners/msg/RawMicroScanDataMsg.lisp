...
(cl:defclass <RawMicroScanDataMsg> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
    :type sick_safetyscanners-msg:DataHeaderMsg
    :initform (cl:make-instance 'sick_safetyscanners-msg:DataHeaderMsg))
   (derived_values
    :reader derived_values
    :initarg :derived_values
    :type sick_safetyscanners-msg:DerivedValuesMsg
    :initform (cl:make-instance 'sick_safetyscanners-msg:DerivedValuesMsg))
   (general_system_state
    :reader general_system_state
    :initarg :general_system_state
    :type sick_safetyscanners-msg:GeneralSystemStateMsg
    :initform (cl:make-instance 'sick_safetyscanners-msg:GeneralSystemStateMsg))
   (measurement_data
    :reader measurement_data
    :initarg :measurement_data
    :type sick_safetyscanners-msg:MeasurementDataMsg
    :initform (cl:make-instance 'sick_safetyscanners-msg:MeasurementDataMsg))
   (intrusion_data
    :reader intrusion_data
    :initarg :intrusion_data
    :type sick_safetyscanners-msg:IntrusionDataMsg
    :initform (cl:make-instance 'sick_safetyscanners-msg:IntrusionDataMsg))
   (application_data
    :reader application_data
    :initarg :application_data
    :type sick_safetyscanners-msg:ApplicationDataMsg
    :initform (cl:make-instance 'sick_safetyscanners-msg:ApplicationDataMsg)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <RawMicroScanDataMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RawMicroScanDataMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sick_safetyscanners-msg:<RawMicroScanDataMsg> is deprecated: use sick_safetyscanners-msg:RawMicroScanDataMsg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <RawMicroScanDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:header-val is deprecated.  Use sick_safetyscanners-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'derived_values-val :lambda-list '(m))
(cl:defmethod derived_values-val ((m <RawMicroScanDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:derived_values-val is deprecated.  Use sick_safetyscanners-msg:derived_values instead.")
  (derived_values m))
...
(cl:defmethod general_system_state-val ((m <RawMicroScanDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:general_system_state-val is deprecated.  Use sick_safetyscanners-msg:general_system_state instead.")
...
(cl:defmethod measurement_data-val ((m <RawMicroScanDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:measurement_data-val is deprecated.  Use sick_safetyscanners-msg:measurement_data instead.")
  (measurement_data m))

(cl:ensure-generic-function 'intrusion_data-val :lambda-list '(m))
(cl:defmethod intrusion_data-val ((m <RawMicroScanDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:intrusion_data-val is deprecated.  Use sick_safetyscanners-msg:intrusion_data instead.")
  (intrusion_data m))

(cl:ensure-generic-function 'application_data-val :lambda-list '(m))
(cl:defmethod application_data-val ((m <RawMicroScanDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:application_data-val is deprecated.  Use sick_safetyscanners-msg:application_data instead.")
  (application_data m))
