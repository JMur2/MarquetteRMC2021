...
(cl:defmethod cl:initialize-instance :after ((m <DerivedValuesMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DerivedValuesMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sick_safetyscanners-msg:<DerivedValuesMsg> is deprecated: use sick_safetyscanners-msg:DerivedValuesMsg instead.")))
...
(cl:defmethod multiplication_factor-val ((m <DerivedValuesMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:multiplication_factor-val is deprecated.  Use sick_safetyscanners-msg:multiplication_factor instead.")
...
(cl:defmethod number_of_beams-val ((m <DerivedValuesMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:number_of_beams-val is deprecated.  Use sick_safetyscanners-msg:number_of_beams instead.")
  (number_of_beams m))

(cl:ensure-generic-function 'scan_time-val :lambda-list '(m))
(cl:defmethod scan_time-val ((m <DerivedValuesMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:scan_time-val is deprecated.  Use sick_safetyscanners-msg:scan_time instead.")
  (scan_time m))
...
(cl:defmethod angular_beam_resolution-val ((m <DerivedValuesMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:angular_beam_resolution-val is deprecated.  Use sick_safetyscanners-msg:angular_beam_resolution instead.")
...
(cl:defmethod interbeam_period-val ((m <DerivedValuesMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:interbeam_period-val is deprecated.  Use sick_safetyscanners-msg:interbeam_period instead.")
  (interbeam_period m))
