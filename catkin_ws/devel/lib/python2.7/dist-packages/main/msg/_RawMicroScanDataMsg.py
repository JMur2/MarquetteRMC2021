...
"""autogenerated by genpy from main/RawMicroScanDataMsg.msg. Do not edit."""
import codecs
import sys
...
class RawMicroScanDataMsg(genpy.Message):
  ...
  _type = "main/RawMicroScanDataMsg"
...
"""
  ...
  _slot_types = ['main/DataHeaderMsg','main/DerivedValuesMsg','main/GeneralSystemStateMsg','main/MeasurementDataMsg','main/IntrusionDataMsg','main/ApplicationDataMsg']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.header is None:
        self.header = main.msg.DataHeaderMsg()
      if self.derived_values is None:
        self.derived_values = main.msg.DerivedValuesMsg()
      if self.general_system_state is None:
        self.general_system_state = main.msg.GeneralSystemStateMsg()
      if self.measurement_data is None:
        self.measurement_data = main.msg.MeasurementDataMsg()
      if self.intrusion_data is None:
        self.intrusion_data = main.msg.IntrusionDataMsg()
      if self.application_data is None:
        self.application_data = main.msg.ApplicationDataMsg()
    else:
      self.header = main.msg.DataHeaderMsg()
      self.derived_values = main.msg.DerivedValuesMsg()
      self.general_system_state = main.msg.GeneralSystemStateMsg()
