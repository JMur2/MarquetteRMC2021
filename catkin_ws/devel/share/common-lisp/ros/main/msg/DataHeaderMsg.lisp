...
(cl:defmethod cl:initialize-instance :after ((m <DataHeaderMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DataHeaderMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main-msg:<DataHeaderMsg> is deprecated: use main-msg:DataHeaderMsg instead.")))

(cl:ensure-generic-function 'version_version-val :lambda-list '(m))
(cl:defmethod version_version-val ((m <DataHeaderMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:version_version-val is deprecated.  Use main-msg:version_version instead.")
  (version_version m))

(cl:ensure-generic-function 'version_major_version-val :lambda-list '(m))
(cl:defmethod version_major_version-val ((m <DataHeaderMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:version_major_version-val is deprecated.  Use main-msg:version_major_version instead.")
...
(cl:defmethod version_minor_version-val ((m <DataHeaderMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:version_minor_version-val is deprecated.  Use main-msg:version_minor_version instead.")
...
(cl:defmethod version_release-val ((m <DataHeaderMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:version_release-val is deprecated.  Use main-msg:version_release instead.")
  (version_release m))
...
(cl:defmethod serial_number_of_device-val ((m <DataHeaderMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:serial_number_of_device-val is deprecated.  Use main-msg:serial_number_of_device instead.")
...
(cl:defmethod serial_number_of_channel_plug-val ((m <DataHeaderMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:serial_number_of_channel_plug-val is deprecated.  Use main-msg:serial_number_of_channel_plug instead.")
...
(cl:defmethod channel_number-val ((m <DataHeaderMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:channel_number-val is deprecated.  Use main-msg:channel_number instead.")
  (channel_number m))

(cl:ensure-generic-function 'sequence_number-val :lambda-list '(m))
(cl:defmethod sequence_number-val ((m <DataHeaderMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:sequence_number-val is deprecated.  Use main-msg:sequence_number instead.")
  (sequence_number m))

(cl:ensure-generic-function 'scan_number-val :lambda-list '(m))
(cl:defmethod scan_number-val ((m <DataHeaderMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:scan_number-val is deprecated.  Use main-msg:scan_number instead.")
  (scan_number m))

(cl:ensure-generic-function 'timestamp_date-val :lambda-list '(m))
(cl:defmethod timestamp_date-val ((m <DataHeaderMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:timestamp_date-val is deprecated.  Use main-msg:timestamp_date instead.")
  (timestamp_date m))

(cl:ensure-generic-function 'timestamp_time-val :lambda-list '(m))
(cl:defmethod timestamp_time-val ((m <DataHeaderMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:timestamp_time-val is deprecated.  Use main-msg:timestamp_time instead.")
  (timestamp_time m))
