...
(cl:defmethod cl:initialize-instance :after ((m <FieldMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FieldMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main-msg:<FieldMsg> is deprecated: use main-msg:FieldMsg instead.")))

(cl:ensure-generic-function 'ranges-val :lambda-list '(m))
(cl:defmethod ranges-val ((m <FieldMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:ranges-val is deprecated.  Use main-msg:ranges instead.")
  (ranges m))
...
(cl:defmethod angular_resolution-val ((m <FieldMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:angular_resolution-val is deprecated.  Use main-msg:angular_resolution instead.")
...
(cl:defmethod protective_field-val ((m <FieldMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:protective_field-val is deprecated.  Use main-msg:protective_field instead.")
  (protective_field m))
