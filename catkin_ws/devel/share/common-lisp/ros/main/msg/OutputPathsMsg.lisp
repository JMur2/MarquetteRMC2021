...
(cl:defmethod cl:initialize-instance :after ((m <OutputPathsMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OutputPathsMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main-msg:<OutputPathsMsg> is deprecated: use main-msg:OutputPathsMsg instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <OutputPathsMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:status-val is deprecated.  Use main-msg:status instead.")
  (status m))

(cl:ensure-generic-function 'is_safe-val :lambda-list '(m))
(cl:defmethod is_safe-val ((m <OutputPathsMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:is_safe-val is deprecated.  Use main-msg:is_safe instead.")
  (is_safe m))

(cl:ensure-generic-function 'is_valid-val :lambda-list '(m))
(cl:defmethod is_valid-val ((m <OutputPathsMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:is_valid-val is deprecated.  Use main-msg:is_valid instead.")
  (is_valid m))
...
(cl:defmethod active_monitoring_case-val ((m <OutputPathsMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:active_monitoring_case-val is deprecated.  Use main-msg:active_monitoring_case instead.")
