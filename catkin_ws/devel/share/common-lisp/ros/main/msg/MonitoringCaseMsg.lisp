...
(cl:defmethod cl:initialize-instance :after ((m <MonitoringCaseMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MonitoringCaseMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main-msg:<MonitoringCaseMsg> is deprecated: use main-msg:MonitoringCaseMsg instead.")))
...
(cl:defmethod monitoring_case_number-val ((m <MonitoringCaseMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:monitoring_case_number-val is deprecated.  Use main-msg:monitoring_case_number instead.")
  (monitoring_case_number m))

(cl:ensure-generic-function 'fields-val :lambda-list '(m))
(cl:defmethod fields-val ((m <MonitoringCaseMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:fields-val is deprecated.  Use main-msg:fields instead.")
  (fields m))

(cl:ensure-generic-function 'fields_valid-val :lambda-list '(m))
(cl:defmethod fields_valid-val ((m <MonitoringCaseMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:fields_valid-val is deprecated.  Use main-msg:fields_valid instead.")
  (fields_valid m))
