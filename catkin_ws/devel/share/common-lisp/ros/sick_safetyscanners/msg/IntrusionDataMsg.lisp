...
(cl:defclass <IntrusionDataMsg> (roslisp-msg-protocol:ros-message)
  ((data
    :reader data
    :initarg :data
    :type (cl:vector sick_safetyscanners-msg:IntrusionDatumMsg)
   :initform (cl:make-array 0 :element-type 'sick_safetyscanners-msg:IntrusionDatumMsg :initial-element (cl:make-instance 'sick_safetyscanners-msg:IntrusionDatumMsg))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <IntrusionDataMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IntrusionDataMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sick_safetyscanners-msg:<IntrusionDataMsg> is deprecated: use sick_safetyscanners-msg:IntrusionDataMsg instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <IntrusionDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:data-val is deprecated.  Use sick_safetyscanners-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <IntrusionDataMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'sick_safetyscanners-msg:IntrusionDatumMsg))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<IntrusionDataMsg>)))
  ...
  (cl:format cl:nil "IntrusionDatumMsg[] data~%~%================================================================================~%MSG: sick_safetyscanners/IntrusionDatumMsg~%uint32 size~%bool[] flags~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'IntrusionDataMsg)))
  "Returns full string definition for message of type 'IntrusionDataMsg"
  (cl:format cl:nil "IntrusionDatumMsg[] data~%~%================================================================================~%MSG: sick_safetyscanners/IntrusionDatumMsg~%uint32 size~%bool[] flags~%~%~%"))
