...
(cl:defclass <ApplicationDataMsg> (roslisp-msg-protocol:ros-message)
  ((inputs
    :reader inputs
    :initarg :inputs
    :type sick_safetyscanners-msg:ApplicationInputsMsg
    :initform (cl:make-instance 'sick_safetyscanners-msg:ApplicationInputsMsg))
   (outputs
    :reader outputs
    :initarg :outputs
    :type sick_safetyscanners-msg:ApplicationOutputsMsg
    :initform (cl:make-instance 'sick_safetyscanners-msg:ApplicationOutputsMsg)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ApplicationDataMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ApplicationDataMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sick_safetyscanners-msg:<ApplicationDataMsg> is deprecated: use sick_safetyscanners-msg:ApplicationDataMsg instead.")))

(cl:ensure-generic-function 'inputs-val :lambda-list '(m))
(cl:defmethod inputs-val ((m <ApplicationDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:inputs-val is deprecated.  Use sick_safetyscanners-msg:inputs instead.")
  (inputs m))

(cl:ensure-generic-function 'outputs-val :lambda-list '(m))
(cl:defmethod outputs-val ((m <ApplicationDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:outputs-val is deprecated.  Use sick_safetyscanners-msg:outputs instead.")
  (outputs m))
