...
(cl:defmethod cl:initialize-instance :after ((m <ScanPointMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ScanPointMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sick_safetyscanners-msg:<ScanPointMsg> is deprecated: use sick_safetyscanners-msg:ScanPointMsg instead.")))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <ScanPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:angle-val is deprecated.  Use sick_safetyscanners-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <ScanPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:distance-val is deprecated.  Use sick_safetyscanners-msg:distance instead.")
  (distance m))

(cl:ensure-generic-function 'reflectivity-val :lambda-list '(m))
(cl:defmethod reflectivity-val ((m <ScanPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:reflectivity-val is deprecated.  Use sick_safetyscanners-msg:reflectivity instead.")
  (reflectivity m))

(cl:ensure-generic-function 'valid-val :lambda-list '(m))
(cl:defmethod valid-val ((m <ScanPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:valid-val is deprecated.  Use sick_safetyscanners-msg:valid instead.")
  (valid m))

(cl:ensure-generic-function 'infinite-val :lambda-list '(m))
(cl:defmethod infinite-val ((m <ScanPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:infinite-val is deprecated.  Use sick_safetyscanners-msg:infinite instead.")
  (infinite m))

(cl:ensure-generic-function 'glare-val :lambda-list '(m))
(cl:defmethod glare-val ((m <ScanPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:glare-val is deprecated.  Use sick_safetyscanners-msg:glare instead.")
  (glare m))

(cl:ensure-generic-function 'reflector-val :lambda-list '(m))
(cl:defmethod reflector-val ((m <ScanPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:reflector-val is deprecated.  Use sick_safetyscanners-msg:reflector instead.")
  (reflector m))

(cl:ensure-generic-function 'contamination-val :lambda-list '(m))
(cl:defmethod contamination-val ((m <ScanPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:contamination-val is deprecated.  Use sick_safetyscanners-msg:contamination instead.")
  (contamination m))
