...
(cl:defmethod cl:initialize-instance :after ((m <ExtendedLaserScanMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExtendedLaserScanMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sick_safetyscanners-msg:<ExtendedLaserScanMsg> is deprecated: use sick_safetyscanners-msg:ExtendedLaserScanMsg instead.")))

(cl:ensure-generic-function 'laser_scan-val :lambda-list '(m))
(cl:defmethod laser_scan-val ((m <ExtendedLaserScanMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:laser_scan-val is deprecated.  Use sick_safetyscanners-msg:laser_scan instead.")
  (laser_scan m))

(cl:ensure-generic-function 'reflektor_status-val :lambda-list '(m))
(cl:defmethod reflektor_status-val ((m <ExtendedLaserScanMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:reflektor_status-val is deprecated.  Use sick_safetyscanners-msg:reflektor_status instead.")
  (reflektor_status m))

(cl:ensure-generic-function 'reflektor_median-val :lambda-list '(m))
(cl:defmethod reflektor_median-val ((m <ExtendedLaserScanMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:reflektor_median-val is deprecated.  Use sick_safetyscanners-msg:reflektor_median instead.")
  (reflektor_median m))

(cl:ensure-generic-function 'intrusion-val :lambda-list '(m))
(cl:defmethod intrusion-val ((m <ExtendedLaserScanMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:intrusion-val is deprecated.  Use sick_safetyscanners-msg:intrusion instead.")
  (intrusion m))
