...
(cl:defclass <MeasurementDataMsg> (roslisp-msg-protocol:ros-message)
  ((number_of_beams
   ...
   (scan_points
    :reader scan_points
    :initarg :scan_points
    :type (cl:vector sick_safetyscanners-msg:ScanPointMsg)
   :initform (cl:make-array 0 :element-type 'sick_safetyscanners-msg:ScanPointMsg :initial-element (cl:make-instance 'sick_safetyscanners-msg:ScanPointMsg))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MeasurementDataMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MeasurementDataMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sick_safetyscanners-msg:<MeasurementDataMsg> is deprecated: use sick_safetyscanners-msg:MeasurementDataMsg instead.")))
...
(cl:defmethod scan_points-val ((m <MeasurementDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-msg:scan_points-val is deprecated.  Use sick_safetyscanners-msg:scan_points instead.")
  (scan_points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MeasurementDataMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'scan_points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'sick_safetyscanners-msg:ScanPointMsg))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MeasurementDataMsg>)))
  ...
  (cl:format cl:nil "uint32 number_of_beams~%ScanPointMsg[] scan_points~%~%~%================================================================================~%MSG: sick_safetyscanners/ScanPointMsg~%float32 angle~%uint16 distance~%uint8 reflectivity~%bool valid~%bool infinite~%bool glare~%bool reflector~%bool contamination~%bool contamination_warning~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MeasurementDataMsg)))
  "Returns full string definition for message of type 'MeasurementDataMsg"
  (cl:format cl:nil "uint32 number_of_beams~%ScanPointMsg[] scan_points~%~%~%================================================================================~%MSG: sick_safetyscanners/ScanPointMsg~%float32 angle~%uint16 distance~%uint8 reflectivity~%bool valid~%bool infinite~%bool glare~%bool reflector~%bool contamination~%bool contamination_warning~%~%~%"))
