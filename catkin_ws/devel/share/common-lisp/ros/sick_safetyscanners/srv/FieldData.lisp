...
(cl:in-package sick_safetyscanners-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <FieldData-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FieldData-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sick_safetyscanners-srv:<FieldData-request> is deprecated: use sick_safetyscanners-srv:FieldData-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FieldData-request>)))
  ...
  "sick_safetyscanners/FieldDataRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FieldData-request)))
  "Returns string type for a service object of type 'FieldData-request"
  "sick_safetyscanners/FieldDataRequest")
...
(cl:defclass <FieldData-response> (roslisp-msg-protocol:ros-message)
  ((fields
    :reader fields
    :initarg :fields
    :type (cl:vector sick_safetyscanners-msg:FieldMsg)
   :initform (cl:make-array 0 :element-type 'sick_safetyscanners-msg:FieldMsg :initial-element (cl:make-instance 'sick_safetyscanners-msg:FieldMsg)))
   (device_name
    :reader device_name
    :initarg :device_name
    :type cl:string
   ...
   (monitoring_cases
    ...
    :type (cl:vector sick_safetyscanners-msg:MonitoringCaseMsg)
   :initform (cl:make-array 0 :element-type 'sick_safetyscanners-msg:MonitoringCaseMsg :initial-element (cl:make-instance 'sick_safetyscanners-msg:MonitoringCaseMsg))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <FieldData-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FieldData-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sick_safetyscanners-srv:<FieldData-response> is deprecated: use sick_safetyscanners-srv:FieldData-response instead.")))

(cl:ensure-generic-function 'fields-val :lambda-list '(m))
(cl:defmethod fields-val ((m <FieldData-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-srv:fields-val is deprecated.  Use sick_safetyscanners-srv:fields instead.")
  (fields m))

(cl:ensure-generic-function 'device_name-val :lambda-list '(m))
(cl:defmethod device_name-val ((m <FieldData-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-srv:device_name-val is deprecated.  Use sick_safetyscanners-srv:device_name instead.")
  (device_name m))

(cl:ensure-generic-function 'monitoring_cases-val :lambda-list '(m))
(cl:defmethod monitoring_cases-val ((m <FieldData-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sick_safetyscanners-srv:monitoring_cases-val is deprecated.  Use sick_safetyscanners-srv:monitoring_cases instead.")
  (monitoring_cases m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <FieldData-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'fields)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'sick_safetyscanners-msg:FieldMsg))
  ...
  (cl:let ((vals (cl:slot-value msg 'monitoring_cases)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'sick_safetyscanners-msg:MonitoringCaseMsg))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FieldData-response>)))
  ...
  "sick_safetyscanners/FieldDataResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FieldData-response)))
  "Returns string type for a service object of type 'FieldData-response"
  "sick_safetyscanners/FieldDataResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FieldData-response>)))
  ...
  (cl:format cl:nil "~%sick_safetyscanners/FieldMsg[] fields~%string device_name~%sick_safetyscanners/MonitoringCaseMsg[] monitoring_cases~%~%~%================================================================================~%MSG: sick_safetyscanners/FieldMsg~%float32[] ranges~%float32 start_angle~%float32 angular_resolution~%bool protective_field~%~%================================================================================~%MSG: sick_safetyscanners/MonitoringCaseMsg~%int32 monitoring_case_number~%int32[] fields~%bool[] fields_valid~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FieldData-response)))
  "Returns full string definition for message of type 'FieldData-response"
  (cl:format cl:nil "~%sick_safetyscanners/FieldMsg[] fields~%string device_name~%sick_safetyscanners/MonitoringCaseMsg[] monitoring_cases~%~%~%================================================================================~%MSG: sick_safetyscanners/FieldMsg~%float32[] ranges~%float32 start_angle~%float32 angular_resolution~%bool protective_field~%~%================================================================================~%MSG: sick_safetyscanners/MonitoringCaseMsg~%int32 monitoring_case_number~%int32[] fields~%bool[] fields_valid~%~%~%"))
